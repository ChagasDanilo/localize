...
import { Title, Button, TextInput, HelperText, Snackbar, Headline, Appbar } from 'react-native-paper';
    ...
    return (
        <View style={{
            ...
            <Appbar.Header
                ...
                <Appbar.Content title={<Title style={{ color: '#345D7E', fontWeight: 'bold' }}>Login</Title>} />
            </Appbar.Header>
            <View style={{
                flex: 1,
